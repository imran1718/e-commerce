          ...
          <Col md={4}>
            <Card>
              ...
              <ListGroup variant="flush" className="order-summary-list">
                ...
                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                  <span>Shipping {cartTotal > 500 ? '(Free over ₹500)' : ''}</span>
                  <span className="text-end order-summary-price">{shippingFee === 0 ? 'Free' : `₹${shippingFee}`}</span>
                </ListGroup.Item>
                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                  <span>Tax (5%)</span>
                  <span className="text-end order-summary-price">₹{taxAmount}</span>
                </ListGroup.Item>
                <ListGroup.Item className="d-flex justify-content-between align-items-center fw-bold border-top">
                  <span>Total</span>
                  <span className="text-end order-summary-price">₹{orderTotal}</span>
                </ListGroup.Item>
              </ListGroup>
              <Card.Footer>
